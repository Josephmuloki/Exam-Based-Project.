    ...
    <div className="home">
        <div className="top_banner">
            <div className="contant">
                <h3>Get Books From All Over East Africa.</h3>
                <h2>From The Best Authors</h2>
                <p>Available in a number of languages</p>
                <Link to="/shop" className="link">Buy Now</Link>
            </div>
        </div>
                ...
                <div className="left_box">
                    <div className="header">
                        <div className="heading">
                            <h2 onClick={()=>allTrendingProducts()}>Trending Books</h2>
                        </div>
                        <div className="cate">
                        ...
                        <div className="testimonial">
                            ...
                            <div className="details">
                                ...
                                <div className="info">
                                    <h3>muloki Joseph</h3>
                                    <h4>Author</h4>
                                    <p>The books are so great. They are delivered on time.
                                        The whole process is just wow.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div className="banner">
            <div className="container">
                <div className="left_box">
                    <div className="box">
                        <img src="img/ff.webp" alt="banner"></img>
                    </div>
                </div>
                <div className="right_box">
                    <div className="top">
